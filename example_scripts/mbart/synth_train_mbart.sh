...
fairseq-train $DATA_BIN \
    ...
    --dropout $DROPOUT --attention-dropout 0.3 \
    ...
    --save-interval-updates 20000 --max-update $TOTAL_NUM_UPDATES \
...
# For training with subword regularization, add the following flags:
# --sentencepiece-enable-sampling --sentencepiece-alpha 0.7 \
