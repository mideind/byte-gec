...
def main() -> None:
    ...
    error_generators = [
        DativitisErrorRule,  # specific to Icelandic
        MoodErrorRule,  # specific to Icelandic
        NounCaseErrorRule,  # specific to Icelandic
        SwapErrorRule,
        DuplicateWordsRule,
        SplitWordsRule,  # specific to Icelandic
        NoiseErrorRule,
        DeleteSpaceErrorRule,
        DropCommaRule,
    ]
